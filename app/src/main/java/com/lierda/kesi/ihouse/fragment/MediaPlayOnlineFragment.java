...
import com.lierda.kesi.ihouse.business.entity.ChannelPTZInfo;
import com.lierda.kesi.ihouse.constants.ProgressDialog;
import com.lierda.kesi.ihouse.util.MediaPlayHelper;
import com.lierda.kesi.ihouse.business.Business.PlayerResultCode;
import com.lierda.kesi.ihouse.business.Business.RetObject;
import com.lierda.kesi.ihouse.util.MediaPlayHelper.DHFilesType;
...
//		}
		...
		encryptKey=b.getString("encryptKey");
...
//				channelInfo.getEncryptKey() != null ? channelInfo.getEncryptKey() : channelInfo.getDeviceCode(), channelInfo.getIndex(), bateMode);
//		mPlayWin.playRtspReal("At_fdb649f6bdb44e008650026dabefd407","2J05604PAD01821","2J05604PAD01821",0,1);
		mPlayWin.playRtspReal(token,deviceId,encryptKey,0,1);
	}
...
//		channelName = channelName.replace("-", "");
		...
		path = MediaPlayHelper.getCaptureAndVideoPath(DHFilesType.DHVideo, channelName);
		// 开始录制 1
