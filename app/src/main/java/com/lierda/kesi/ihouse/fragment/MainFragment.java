...
//    public static String baseurl = "file:///android_asset/www/";
    public static String baseurl = "file:///data/data/com.lierda.kesi.ihouse/public/";
    private  final  static String  serverUrl="http://39.104.69.85:8585/action";
    private MainActivity uiActivity;
    private Handler uiHandler;
    private  String imgUrl;
    static {
        File www=new File("/data/data/com.lierda.kesi.ihouse/public");
        if(www.exists()){
            baseurl = "file:///data/data/com.lierda.kesi.ihouse/public/";
        }else {
